...
class ScreensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post screens_url, params: { screen: { cinema_id: @screen.cinema_id, film_playing: @screen.film_playing, screen_no: @screen.screen_no } }
    end
  ...
  test "should update screen" do
    patch screen_url(@screen), params: { screen: { cinema_id: @screen.cinema_id, film_playing: @screen.film_playing, screen_no: @screen.screen_no } }
